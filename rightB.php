...
<?php
   ...
   ?>
   <form name="myForm" method="post" action="postB.php">
          <table border="0" width="800" cellspacing="0">
            <tr bgcolor="#0084CA" align="center">
              <td colspan="2">
                <font color="#FFFFFF">有什麼好康發布?</font></td>
            </tr>
            <tr bgcolor="#D9F2FF">
              <td width="15%">商家</td>
            ...
            <tr>
              <td colspan="2" align="center">
                <input type="button" value="留言" onClick="check_data()">　
...
<div id="TabbedPanels1" class="TabbedPanels">
  ...
  <div class="TabbedPanelsContentGroup">
    ...
    <div class="TabbedPanelsContent">內容4</div>
  </div>
</div>
<script type="text/javascript">
