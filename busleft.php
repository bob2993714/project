...
<p><?php
   ...
   ?></p>
	  <div><img src="images/<?php echo $file_name; ?>" width="180" height="200"/></div>
        ...
        <p>服務效率</p>
        <p>菜色口味</p>
      <INPUT TYPE="button" VALUE="上傳大頭貼" onClick="parent.mainFrame.location.href='uploadB.php'">
	  <INPUT TYPE="button" VALUE="登記新商品" onClick="parent.mainFrame.location.href='merchandise.html'"><br>
