...
ul.nav a, ul.nav a:visited { /* 將這些選取器放入群組，即可確保您的連結即使在受到點擊後仍保有按鈕外觀 */
	...
	width: 200px;  /*這個寬度使整個按鈕都可用於 IE6 的點按動作。如果不需要支援 IE6，就可將其移除。請從側邊列容器的寬度減去此連結的間距來計算適當的寬度。 */
	text-decoration: none;
  ...
  <div class="sidebar1">
      ...
      <p><?php
			...
			if(isset($_SESSION['username']) ){
				...
				$sql = "select photo from customer where account = '$username'";
   ...
   ?></p>
      ...
      <INPUT TYPE="button" VALUE="上傳大頭貼" onClick="parent.mainFrame.location.href='upload.php'">
	  <INPUT TYPE="button" VALUE="朋友" onClick="parent.mainFrame.location.href=''">
	  <INPUT TYPE="button" VALUE="設定" onClick="parent.mainFrame.location.href=''">
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
